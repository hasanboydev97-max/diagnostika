        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-8">
          <div className="relative w-full md:w-96 flex items-center">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-3 bg-white border border-zinc-200/80 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10 transition-all shadow-xs text-sm"
              value={search}
        ...
        <div>
          {loading ? (
            ...
            <div className="bg-white border border-zinc-200/80 rounded-2xl p-16 flex flex-col items-center justify-center text-center shadow-xs">
              <div className="w-16 h-16 bg-indigo-50/70 rounded-full flex items-center justify-center mb-5 border border-indigo-100">
                <FileText className="text-indigo-600" size={32} strokeWidth={1.5} />
              </div>
            ...
            >
              {filteredTests.map((test) => (
                <motion.div
                  ...
                  className="bg-white border border-zinc-200/80 hover:border-indigo-300 transition-all rounded-2xl p-5 md:p-6 flex flex-col justify-between relative group shadow-xs hover:shadow-md cursor-pointer"
                >
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-4">
                      <span className="inline-flex items-center px-2.5 py-1 bg-indigo-50 text-indigo-700 text-[10px] font-bold uppercase tracking-wider rounded-md">{test.subject}</span>
                      <button 
                    ...
                    <h3 className="text-lg font-bold text-zinc-900 group-hover:text-indigo-600 transition-colors mb-3 line-clamp-2 leading-snug">{test.title}</h3>
                  </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-zinc-100 flex items-center justify-between">
                    ...
                    <div className="w-8 h-8 rounded-xl bg-zinc-50 flex items-center justify-center group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                      <ChevronRight size={16} className="text-zinc-400 group-hover:text-white transition-colors" strokeWidth={2} />
                    </div>
                  </div>
                </motion.div>
              ))}
