            ...
            <div className="bg-white/60 backdrop-blur-xl border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 rounded-2xl">
              ...
              <div className="pt-4 border-t border-zinc-100 flex flex-col gap-2.5">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-3 py-2.5 bg-[#46178f] text-white text-xs font-bold rounded-md hover:bg-[#381272] transition-colors shadow-sm mb-1"
                >
                ...
                <button
                  ...
                  className="w-full mt-1.5 flex items-center justify-center gap-2 px-3 py-2.5 bg-gradient-to-r from-violet-600 to-indigo-600 text-white text-xs font-semibold rounded-md hover:from-violet-700 hover:to-indigo-700 transition-all shadow-md"
                >
